...
! function(t, e, i, n) {
    ...
    function i(t, e, i) {
        $(".main-content").children().removeClass("section--is-active"), $(".main-content").children().eq(e).addClass("section--is-active"), $(".main-content .section").children().removeClass("section--next section--prev"), $(".tag").removeClass("tag-is-active"),$(".tag").eq(e).addClass("tag-is-active"), t === i && 0 === e || 0 === t && e === i ? $(".main-content .section").children().removeClass("section--next section--prev") : e > t ? $(".main-content").children().eq(t).children().addClass("section--next") : $(".main-content").children().eq(t).children().addClass("section--prev"), 0 !== e && e !== i ? ($(".header--cta").addClass("is-active"), $(".footer").addClass("is-active")) : ($(".header--cta").removeClass("is-active"),$(".footer").removeClass("is-active")), i === e ? ($('.t1').addClass('t1-is-active'),$('.t2').addClass('t2-is-active'),$('.t3').addClass('t3-is-active'),$('.t4').addClass('t4-is-active'),$('.t5').addClass('t5-is-active'),$('.t6').addClass('t6-is-active')): ($('.t1').removeClass('t1-is-active'),$('.t2').removeClass('t2-is-active'),$('.t3').removeClass('t3-is-active'),$('.t4').removeClass('t4-is-active'),$('.t5').removeClass('t5-is-active'),$('.t6').removeClass('t6-is-active'));
    }
